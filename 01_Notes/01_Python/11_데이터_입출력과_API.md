...
- [1. 파일 입출력 (File I/O)](#1-파일-입출력-file-io)
  ...
  - [1.1.1 컨텍스트 관리자 (Context Manager)의 이해](#111-컨텍스트-관리자-context-manager-의-이해)
...
- [2. 표준 데이터 형식 다루기](#2-표준-데이터-형식-다루기)
  ...
  - [2.1.1 Pandas를 이용한 CSV 처리 (데이터 과학 분야)](#211-pandas를-이용한-csv-처리-데이터-과학-분야)
...
- [3. 외부 API 연동: `requests` 라이브러리](#3-외부-api-연동-requests-라이브러리)
  - [3.1 Session 객체 사용 (성능 및 상태 관리)](#31-session-객체-사용-성능-및-상태-관리)
  - [3.2 API 호출 로깅](#32-api-호출-로깅)
  - [3.3 API Rate Limiting (요청 제한) 및 Pagination (페이지네이션)](#33-api-rate-limiting-요청-제한-및-pagination-페이지네이션)
- [3.4 웹 스크래핑 기초 및 윤리적 고려사항](#34-웹-스크래핑-기초-및-윤리적-고려사항)
- [4. 데이터 유효성 검사 (Data Validation)](#4-데이터-유효성-검사-data-validation)
  ...
  - [4.4.1 스키마 정의 언어 활용 (JSON Schema, OpenAPI)](#441-스키마-정의-언어-활용-json-schema-openapi)
