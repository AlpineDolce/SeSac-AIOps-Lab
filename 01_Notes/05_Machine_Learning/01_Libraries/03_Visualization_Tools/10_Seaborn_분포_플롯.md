...
- [1. Seaborn 분포 플롯 개요](#1-seaborn-분포-플롯-개요)
  ...
  - [1.3. `displot()`: 고수준 분포 플롯 인터페이스](#13-displot-고수준-분포-플롯-인터페이스)
    - [1.3.1. `kind` 매개변수를 이용한 히스토그램, KDE, ECDF](#131-kind-매개변수를-이용한-히스토그램-kde-ecdf)
    - [1.3.2. `col`, `row` 매개변수를 이용한 서브플롯 생성](#132-col-row-매개변수를-이용한-서브플롯-생성)
...
#### 1.3.1. `kind` 매개변수를 이용한 히스토그램, KDE, ECDF
...
plt.figure(figsize=(15, 5)) # displot은 figure-level이므로 subplot 사용 불가
...
#### 1.3.2. `col`, `row` 매개변수를 이용한 서브플롯 생성
